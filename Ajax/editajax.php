    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col bg-primary d-flex justify-content-center p-2">
                ...
                First Name :<input type="text" class="mx-2" id="fname" placeholder="Enter First Name"> </input>
                Last Name :  <input type="text"class="mx-2" id="lname" placeholder="Enter Last Name" > </input>
        ...
        ?>
                      ...
                      <tr>
                        ...
                        <td> <input type="text" id="lname" placeholder="<?php echo $s_first_name ?>" > </input></td>
                        <td> <input type="text" id="lname" placeholder="<?php echo $s_last_name ?>" > </input></td>
